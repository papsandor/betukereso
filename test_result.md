...
agent_communication:
    ...
    - agent: "testing"
    - agent: "main"
      message: "Kérlek, teszteld a beállítások mentését JSON body-val (PUT /api/children/{child_id}/settings), a stickers_enabled logikát (kikapcsolva ne adjon matricát), az additional_sticker_interval működését (10 után N-enként), a 20+ matrica utáni esélycsökkentést, és hogy a sticker_earned most leírást (description) is tartalmaz. A StickerBook 102 slotot és ❓-eket mutasson az üres helyeken."
